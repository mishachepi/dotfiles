...
VAULT_MAIN="/Volumes/mch"
VAULT_WORK="/Users/m_chepkin/OneDrive - Wargaming.net/OneDrive"
...
vault_info "Main vault (mind)" "$VAULT_MAIN"
vault_info "Work vault (WGG)" "$VAULT_WORK"
